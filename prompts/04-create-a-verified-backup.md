...
**For my agent:** Read **Before You Trust OpenClaw: Backups, Access, and a Recovery Plan** at `RUNBOOK_RELEASE_URL_PENDING`, especially **Sections 4 and 5, Choose a backup method and destination** and **Create and verify the supported archive**, before acting. If the address still says `RUNBOOK_RELEASE_URL_PENDING`, stop and ask me to provide the included local runbook file.
