...
Notable changes to the OpenClaw Runbook 1 package. Dates use YYYY-MM-DD.

## 0.1.0 (planned first release, review-ready, not yet released) - 2026-09-16

Initial public package for OpenClaw Runbook 1: Before You Trust OpenClaw.

- Canonical agent-facing runbook for establishing backup, access, rollback, and recovery capabilities on a Linux or WSL OpenClaw installation.
